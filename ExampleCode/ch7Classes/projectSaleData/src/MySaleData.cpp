...
const exception saleData::SALE_INP_ERROR{"saleData:: istream exception"};
const exception saleData::SALE_OUT_ERROR{"saleData:: ostream execption"};
const exception saleData::SALE_ART_ERROR{"saleData:: airthmetic exception"};
